...
class Robot:
  ...
  #Moves forward 1 step based on facing. I could make this more efficient.
  def move(self):
    if self.facing == 0:
      self.y += -1
    elif self.facing == 1:
  ...
  #The following functions are a hack in order to count squares that have been painted more than once.
